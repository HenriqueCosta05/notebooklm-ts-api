...
export const artifactStatusToStr = (statusCode: number): string =>
  ARTIFACT_STATUS_MAP[statusCode] ?? "unknown";

export const sourceStatusToStr = (statusCode: number): string =>
  SOURCE_STATUS_MAP[statusCode] ?? "unknown";
